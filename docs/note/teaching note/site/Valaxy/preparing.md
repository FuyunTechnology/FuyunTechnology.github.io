...
permalink: /note/teaching note/site/Valaxy/preparing/
outline: 'deep'
prev: false
description: "本文创作学习了以下页面"
contentPosition: after
list:
  -
   name: yuumi 
   link: https://www.yuumi.link/posts/valaxy 
...
>
> 打开它，在左侧侧栏找到扩展图标 （第5个）打开或者使用快捷键`ctrl`+`shift`+`X`，在那个页面搜Chinese（Simply），安装插件，并同意右下角的 语言更改提示.这样，就是中文界面啦。
